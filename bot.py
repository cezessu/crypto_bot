...
def get_lesson_requirement_text(lesson_number):
    ...
    requirements = {
        ...
        2: (
            ...
            "2. Соверши первую сделку.\n"
            "3. Пришли боту свой UID из профиля MEXC — бот проверит условие автоматически."
        ),
        3: (
            "📘 <b>Как получить методичку №3</b>\n\n"
            "Нужен общий торговый объём от 300 USDT. Пришли свой UID MEXC: "
            "бот проверит реферальную привязку, а объём подтвердит администратор."
        ),
        4: (
            "📘 <b>Как получить методичку №4</b>\n\n"
            "Пригласи 1 друга через кнопку «👥 Моя ссылка и друзья». Друг должен "
            "привязать свой MEXC UID и совершить сделку."
        ),
        5: (
            "📘 <b>Как получить методичку №5</b>\n\n"
            "После первой подтверждённой сделки сохраняй торговую активность 30 дней. "
            "Затем бот проверит новую сделку по твоему UID MEXC."
        ),
        6: (
            "📘 <b>Как получить методичку №6</b>\n\n"
            "Пригласи 2 друзей через кнопку «👥 Моя ссылка и друзья». Каждый друг "
            "должен привязать MEXC UID и совершить сделку."
        ),
        7: (
            "📘 <b>Как получить методичку №7</b>\n\n"
            "Выполни одно из условий: общий торговый объём от 5 000 USDT или "
            "3 квалифицированных приглашённых друга."
        ),
    }
    return requirements.get(lesson_number, "")
...
def process_lesson_request(message, lesson_number):
    ...
    instruction_text = (
        "🔍 <b>Где найти свой UID на MEXC</b>\n\n"
